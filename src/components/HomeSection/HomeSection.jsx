...
const HomeSection = () => {
  ...
  return (
    ...
    >
      <Slideshow />
      {/* categories */}
      <div className="categories w-full bg-gradient-to-br from-gray-100 to-[#FADAD4] px-10 pt-10 m-0">
        ...
        <div className="categories-container flex justify-between animation-element">
          {categoryList.map((catItem, index) => {
            return (
              <div
                className="catItem border-[3px] rounded-xl bg-white h-[10rem] w-[10rem] text-black font-mono text-lg font-bold flex flex-col gap-3 justify-center items-center text-center hover:bg-red-400  hover:text-white cursor-pointer active:border-[2.5px] active:border-red-500 active:text-red-500 active:bg-transparent  animate_animated hover:animate__pulse"
                key={index}
        ...
        <div className="item-section py-10 bg-gradient-to-br from-[#F5EEEF] to-[#FADAD4]  w-auto overflow-x-scroll">
